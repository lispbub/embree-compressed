...
INSTALL(FILES ${PROJECT_SOURCE_DIR}/LICENSE.embree DESTINATION ${CMAKE_INSTALL_DOCDIR} COMPONENT lib)
...
SET(CPACK_RESOURCE_FILE_LICENSE ${PROJECT_SOURCE_DIR}/LICENSE.embree)
...
ELSEIF(APPLE)
  ...
  CONFIGURE_FILE(README.md README.embree)
  SET(CPACK_RESOURCE_FILE_README ${PROJECT_BINARY_DIR}/README.embree)
